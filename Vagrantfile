...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "data", "/home/vagrant/ml_data"
  config.vm.synced_folder "scripts", "/home/vagrant/ml_scripts"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    cd Downloads
    wget -nv https://repo.anaconda.com/archive/Anaconda3-2019.10-Linux-x86_64.sh
    chmod 755 Anaconda3-2019.10-Linux-x86_64.sh
  # install conda the configure yes yes configure allows for automation
    ./Anaconda3-2019.10-Linux-x86_64.sh -b -p /home/vagrant/software/anaconda3
